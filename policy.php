...
<head>
  ...
  <title><?php echo $lang['policy_page_title']; ?></title>
...
<body>
  ...
  <main id="kd-page" class="container" data-page="policy">
    <div class="card">
      <h2><span><?php echo $lang['policy_title_span']; ?></span> <?php echo $lang['policy_title']; ?></h2>
      <p class="updated"><?php echo $lang['policy_last_updated']; ?></p>

      <h3><?php echo $lang['policy_intro_title']; ?></h3>
      <p><?php echo $lang['policy_intro_p1']; ?></p>

      <h3><?php echo $lang['policy_info_title']; ?></h3>
      <p><?php echo $lang['policy_info_p1']; ?></p>
      <ul>
          <li><?php echo $lang['policy_info_li1']; ?></li>
          <li><?php echo $lang['policy_info_li2']; ?></li>
          <li><?php echo $lang['policy_info_li3']; ?></li>
      </ul>

      <h3><?php echo $lang['policy_usage_title']; ?></h3>
      <p><?php echo $lang['policy_usage_p1']; ?></p>
      <ul>
          <li><?php echo $lang['policy_usage_li1']; ?></li>
          <li><?php echo $lang['policy_usage_li2']; ?></li>
          <li><?php echo $lang['policy_usage_li3']; ?></li>
          <li><?php echo $lang['policy_usage_li4']; ?></li>
      </ul>

      <h3><?php echo $lang['policy_sharing_title']; ?></h3>
      <p><?php echo $lang['policy_sharing_p1']; ?></p>
      <ul>
          <li><?php echo $lang['policy_sharing_li1']; ?></li>
          <li><?php echo $lang['policy_sharing_li2']; ?></li>
      </ul>

      <h3><?php echo $lang['policy_security_title']; ?></h3>
      <p><?php echo $lang['policy_security_p1']; ?></p>

      <h3><?php echo $lang['policy_contact_title']; ?></h3>
      <p><?php echo $lang['policy_contact_p1']; ?> <a href="mailto:support@kisanx.com" style="color: var(--kd-earthy-green);">support@kisanx.com</a></p>
    </div>
  </main>
